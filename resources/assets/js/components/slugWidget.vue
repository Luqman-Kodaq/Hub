      ...
      <div class="slug-widget">
          <div class="icon-wrapper wrapper">
            ...
            <div class="url-wrapper wrapper">
              ...
              <input type="text" name="slug" id="slug-editor" class="form-control" v-show="isEditing" v-model="customSlug" @keyup="adjustWidth" @keydown.esc.prevent @keydown.enter.prevent/>
            </div>

          <div class="button-wrapper wrapper">
            <button class="btn btn-light btn-sm save-slug-button" v-show="!isEditing" @click.prevent="editSlug">{{slug.length < 1 ? 'Create New Slug' : 'Edit'}}</button>          
            <button class="btn btn-success btn-sm save-slug-button" v-show="isEditing" @click.prevent="saveSlug">Save</button>
            <button class="btn btn-light btn-sm save-slug-button" v-show="isEditing" @click.prevent="resetEditing">Reset</button>
          </div>
      </div>
</template>
